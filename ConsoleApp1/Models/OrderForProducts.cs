...
namespace ConsoleApp1.Models
{
    ...
    public class OrderForProducts
    {
        ...
        // 带参数的构造函数
        public OrderForProducts(int orderID, string productName, string state, string customerID, int number, DateTime day, string paymentMethod, int price)
        {
            OrderID = orderID;
