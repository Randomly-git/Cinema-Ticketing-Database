    ...
    namespace cinemaapp
    {
        static class Program
        {
            ...
            public static IRatingService _ratingService;
            ...
            public static IRelatedProductRepository _relatedProductRepository;
        ...
        [STAThread]
            static void Main()
            {
                ...
                _ratingRepository = new OracleRatingRepository(connectionString);
