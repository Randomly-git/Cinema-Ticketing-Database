...
namespace test.Repositories
{
    ...
    public class OracleRelatedProductRepository : IRelatedProductRepository
    {
        ...
        public List<RelatedProduct> GetAllProducts()
        {
            ...
            string sql = "SELECT PRODUCTNAME, PRICE, PRODUCTNUMBER FROM RELATEDPRODUCT";
        ...
        public RelatedProduct GetProductByName(string productName)
        {
            ...
            string sql = "SELECT PRODUCTNAME, PRICE, PRODUCTNUMBER FROM RELATEDPRODUCT WHERE PRODUCTNAME = :productName";
